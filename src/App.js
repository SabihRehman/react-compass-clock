                ...
                <header className="App-header">
                    ...
                    <div className="box">
                        ...
                        {this.array(7).map((x, index) => {
                            return(
                                <div key={index} className={`week item ${index === (this.state.week-1)? "active":""}`} style={{transform: `rotate(${index*(360/21)-(360/21)*(this.state.week-1)}deg)`}}>
                                    {`week ${x}`}
                                </div>
                            )
                        })}     
                        ...
                        {this.array(60).map((x,index)=>{
                            return (
                                <div key={index}
                                    className={`minute item ${index ===(this.state.minute)? 'active':''}`} style={{transform: `rotate(${index*(360/60)-(360/60) * (this.state.minute-1)}deg)`}}>
                                    {`${x} min`}
                                </div>
                            )
                        })}
                        ...
                        {this.array(60).map((x,index)=>{
                            return (
                                <div key={index}
                                    className={`second item ${index ===(this.state.second)? 'active':''}`} style={{transform: `rotate(${index*(360/60)-(360/60) * (this.state.second-1)}deg)`}}>
                                    {`${x} sec`}
                                </div>
                            )
                        })} 
